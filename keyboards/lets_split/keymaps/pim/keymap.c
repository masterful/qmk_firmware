...
[_LOWER] = KEYMAP( \
  ...
  KC_LCTL, ADJUST,  LOWER,   RAISE,   KC_LALT, _______, KC_LGUI, KC_KP_0, _______, _______, _______, KC_PDOT, _______, ADJUST \
),
...
[_RAISE] = KEYMAP( \
  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   _______, _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12, \
  _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PGDN, KC_PGUP, _______, _______, KC_BSPC, \
...
[_ADJUST] =  KEYMAP( \
  ...
  KC_LSFT, _______, _______, _______, _______, _______, _______, KC_BTN1, KC_BTN5, KC_SPDN, KC_SPUP, KC_SPRT, KC_ACL0, _______, \
